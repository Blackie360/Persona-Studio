...
interface GlobalDropZoneProps {
  ...
  setDropZoneHover: (zone: 1 | 2 | null) => void
...
export function GlobalDropZone({
  ...
  if (singleSlot) {
    return (
      <div
        className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center px-8"
        onDrop={(e) => {
          e.preventDefault()
          onDrop(e, 1)
        }}
      ...
      >
        <div
          ...
          onDragEnter={() => setDropZoneHover(1)}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        onDragEnter={() => setDropZoneHover(2)}
        onDragLeave={() => setDropZoneHover(null)}
        onDragOver={(e) => {
          e.preventDefault()
          e.stopPropagation()
